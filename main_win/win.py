...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.groupBox_18.setStyleSheet("#groupBox_18{border-image: url(:/img/icon/);\n"
...
"border-radius:0px;}")
        ...
        self.label_7.setStyleSheet("image: url(:/img/icon/);")
...
"")
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "AOI Inspection GUI Tool"))
        self.label_4.setText(_translate("mainWindow", " GUI"))
